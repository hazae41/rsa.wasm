...
export class RsaPrivateKey {
     ...
     */
    constructor(length) {
        const ret = wasm.rsaprivatekey_new(length);
        if (ret[2]) {
    ...
    static from_pkcs1_der(input) {
        ...
        const ret = wasm.rsaprivatekey_from_pkcs1_der(input.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return RsaPrivateKey.__wrap(ret[0]);
    }
    /**
     * @param {Memory} input
     * @returns {RsaPrivateKey}
    ...
    static from_pkcs8_der(input) {
        _assertClass(input, Memory);
        const ret = wasm.rsaprivatekey_from_pkcs8_der(input.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return RsaPrivateKey.__wrap(ret[0]);
     ...
     */
    to_pkcs1_der() {
        const ret = wasm.rsaprivatekey_to_pkcs1_der(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    to_pkcs8_der() {
        const ret = wasm.rsaprivatekey_to_pkcs8_der(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Memory.__wrap(ret[0]);
    ...
    sign_pkcs1v15_unprefixed(input) {
        _assertClass(input, Memory);
        const ret = wasm.rsaprivatekey_sign_pkcs1v15_unprefixed(this.__wbg_ptr, input.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Memory.__wrap(ret[0]);
...
export class RsaPublicKey {
    ...
    static from_pkcs1_der(input) {
        _assertClass(input, Memory);
        const ret = wasm.rsapublickey_from_pkcs1_der(input.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return RsaPublicKey.__wrap(ret[0]);
    }
    /**
     * @param {Memory} input
     * @returns {RsaPublicKey}
    ...
    static from_public_key_der(input) {
        _assertClass(input, Memory);
        const ret = wasm.rsapublickey_from_public_key_der(input.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return RsaPublicKey.__wrap(ret[0]);
     ...
     */
    to_pkcs1_der() {
        const ret = wasm.rsapublickey_to_pkcs1_der(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Memory.__wrap(ret[0]);
     ...
     */
    to_public_key_der() {
        const ret = wasm.rsapublickey_to_public_key_der(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Memory.__wrap(ret[0]);
